...
'ReplaceBin0
'Die gleiche Routine nochmal, allerdings mit den etwas langsameren String-Funktionen (d.h. Len statt LenB, InStr statt InStrB u.‰.):
...
'In der Prozedur muss keine R¸ckgabevariable verwaltet werden:
